...

{
...

    {
...

        {
            ...
            PlayerFSMState_ATTACK attackState =
            (PlayerFSMState_ATTACK)_player.playerFSM.GetState(PlayerFSMStateType.ATTACK
            );
...
if (_player.bulletsInMagazine == 0 && _player.totalAmunitionCount >
0)
